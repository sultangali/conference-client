...
export const fetchLogin = createAsyncThunk('auth/fetchLogin', async (params, { rejectWithValue }) => {
    try {
        const response = await tools.axios.post('/api/user/auth/login', params)
...
export const fetchRegister = createAsyncThunk('auth/fetchRegister', async (params, { rejectWithValue }) => {
    try {
        const response = await tools.axios.post('/api/user/auth/registration', params)
        return response.data
    } catch (error) {
        if (!error.response) {
            throw error
...
export const fetchUpdateProfile = createAsyncThunk('auth/fetchUpdateProfile', async (params, { rejectWithValue }) => {
    try {
        const response = await tools.axios.patch('api/user/me/update', params)
        return response.data
    } catch (error) {
        if (!error.response) {
            throw error
...
export const fetchAllUsers = createAsyncThunk("auth/fetchAllUsers", async () => {
    const { data } = await tools.axios.get(`/api/user/all`);
    return data;
}
)

export const fetchAuthMe = createAsyncThunk('auth/fetchAuthMe', async () => {
    const { data } = await tools.axios.get('/api/user/me')
    return data
})
